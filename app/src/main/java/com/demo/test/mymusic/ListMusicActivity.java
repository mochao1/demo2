...
public class ListMusicActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        musicBaseInfos.add(new MusicBaseInfo(testInfo1,voiceInfo1,"吉他", R.mipmap.jita,R.string.jita_text,"http://www.iqiyi.com/v_19rromes0s.html",""));
        VoiceInfo voiceInfo2=new VoiceInfo(R.raw.dianziqin_sht_sat,"上海滩","SAT轻音乐团");
        List<TestInfo> testInfo2=DataCenter.getdianziqin();
        musicBaseInfos.add(new MusicBaseInfo(testInfo2,voiceInfo2,"电子琴", R.mipmap.dianziqin,R.string.dianziqin,"https://www.iqiyi.com/v_19ruphuyzs.html",""));
        VoiceInfo voiceInfo3=new VoiceInfo(R.raw.dizi_mdzs_hh,"花火","草木 魔道祖师");
        List<TestInfo> testInfo3=DataCenter.getdizi();
        musicBaseInfos.add(new MusicBaseInfo(testInfo3,voiceInfo3,"笛子", R.mipmap.dizi,R.string.dizi,"http://www.iqiyi.com/v_19rrnq9xuo.html",""));
        VoiceInfo voiceInfo4=new VoiceInfo(R.raw.erhu_ab_eqyy,"二泉映月","阿炳");
        List<TestInfo> testInfo4=DataCenter.geterhu();
        musicBaseInfos.add(new MusicBaseInfo(testInfo4,voiceInfo4,"二胡", R.mipmap.erhu,R.string.erhu,"http://www.iqiyi.com/v_19rrnq33es.html",""));
        VoiceInfo voiceInfo5=new VoiceInfo(R.raw.gangqin_zhy_ysgqq,"时间都去哪了","赵海洋");
        List<TestInfo> testInfo5=DataCenter.getgangqin();
        musicBaseInfos.add(new MusicBaseInfo(testInfo5,voiceInfo5,"钢琴", R.mipmap.gangqin,R.string.gangqing,"http://v.youku.com/v_show/id_XMTM5MTM1ODk1Mg==.html",""));
        VoiceInfo voiceInfo6=new VoiceInfo(R.raw.gu_qx_lhdg,"气","群星");
        List<TestInfo> testInfo6=DataCenter.getzhongguogu();
        musicBaseInfos.add(new MusicBaseInfo(testInfo6,voiceInfo6,"中国鼓", R.mipmap.gu,R.string.gu,"",""));
        VoiceInfo voiceInfo7=new VoiceInfo(R.raw.jiazigu_ctznl_rxg,"春天在哪里","任小果");
        List<TestInfo> testInfo7=DataCenter.getjiazigu();
        musicBaseInfos.add(new MusicBaseInfo(testInfo7,voiceInfo7,"架子鼓", R.mipmap.jiazigu,R.string.jiazigu,"http://www.iqiyi.com/v_19rrk91bxc.html",""));
        VoiceInfo voiceInfo8=new VoiceInfo(R.raw.sakesi_hj_kg,"回家","Kenny G");
        List<TestInfo> testInfo8=DataCenter.getsakesi();
        musicBaseInfos.add(new MusicBaseInfo(testInfo8,voiceInfo8,"萨克斯", R.mipmap.sakesi,R.string.sakesi,"https://www.iqiyi.com/v_19rr9azdcc.html",""));
